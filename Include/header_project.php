...
<body>
  ...
  <div class="mobile-menu" id="mobileMenu">
    ...
    <div class="w-100 d-flex flex-column align-items-center mt-2 mobile-nav-buttons">
      ...
      <button onclick="location.href='project_approval.php'"><i class="fas fa-file-circle-check"></i>Project Approval</button>
      <button onclick="location.href='purchase-req.php'"><i class="fas fa-truck-ramp-box"></i>Procurement Request</button>
  ...
  <div class="left-header d-none d-md-flex">
    ...
    <div class="nav-buttons">
      ...
      <button onclick="location.href='project-approval.php'"><i class="fas fa-file-circle-check"></i>Project Approval</button>
      <button onclick="location.href='purchase-req.php'"><i class="fas fa-truck-ramp-box"></i>Procurement Request</button>
    </div>
